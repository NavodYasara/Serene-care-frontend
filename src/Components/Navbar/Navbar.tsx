    ...
    >
      ...
      >
        <MenuItem
          ...
          sx={{ py: 1.5 }}
        >
          <Typography textAlign="center" fontWeight={600} color="#2D3748">
            Home
          </Typography>
        </MenuItem>
        ...
        {user ? (
          [
            ...
            <MenuItem key="logout" onClick={handleLogout} sx={{ py: 1.5 }}>
              <Typography textAlign="center" fontWeight={600} color="#E53E3E">
                Logout
              </Typography>
            </MenuItem>,
          ]
          ...
          <MenuItem
            ...
            sx={{ py: 1.5 }}
          >
            <Typography textAlign="center" fontWeight={600} color="#2E8B57">
              Login
            </Typography>
          </MenuItem>
        )}
